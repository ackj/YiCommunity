...
import com.aglhz.yicommunity.common.bean.BuildingBean;
import com.aglhz.yicommunity.common.bean.CommunitySelectBean;
import com.aglhz.yicommunity.common.bean.FloorBean;
import com.aglhz.yicommunity.common.bean.IconBean;
import com.aglhz.yicommunity.common.bean.MyHourseBean;
import com.aglhz.yicommunity.common.bean.RoomBean;
import com.aglhz.yicommunity.common.bean.UnitBean;
...
//        mModel.start();
    ...
    public void requestCommunity(String province, String city, String county) {
        ...
        HttpClient.post(ServiceApi.communityList, params, new BeanCallback<CommunitySelectBean>() {
            @Override
    ...
    public void requestBuilding(String communityCode) {
        ...
        HttpClient.post(ServiceApi.BUILDING_LIST, params, new BeanCallback<BuildingBean>() {
            @Override
            public void onError(String errMsg) {
    ...
    public void requestUnit(String communityCode, String buildingCode) {
        ...
        HttpClient.post(ServiceApi.UNIT_LIST, params, new BeanCallback<UnitBean>() {
            @Override
            public void onError(String errMsg) {
    ...
    public void requestFloor(String communityCode, String buildingCode, String unitCode) {
        ...
        HttpClient.post(ServiceApi.FLOOR_LIST, params, new BeanCallback<FloorBean>() {
            @Override
            public void onError(String errMsg) {
    ...
    public void requestRoom(String communityCode, String buildingCode, String unitCode, String floorCode) {
        ...
        HttpClient.post(ServiceApi.ROOM_LIST, params, new BeanCallback<RoomBean>() {
            @Override
            public void onError(String errMsg) {
    ...
    public void requestApply(boolean isProprietor, String cmnt_c, final String bdg_c, String bdg_u_c, String bdg_f_c, String bdg_f_h_c, String applyName, String idNO) {
        ...
        HttpClient.post(ServiceApi.apply(isProprietor), param, new BeanCallback<BaseBean>() {
            @Override
            public void onError(String errMsg) {
